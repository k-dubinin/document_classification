...
# --- Naive Bayes (мультиномиальный; часто используют с признаками текста) ---
NB_ALPHA = 1.0

# --- Линейный SVM (LinearSVC; хорошо сочетается с TF-IDF для текста) ---
SVM_C = 1.0
SVM_MAX_ITER = 2000

# --- Пути для сохранения артефактов (относительно корня проекта можно переопределить в CLI) ---
