...
- `GET /api/v1/model/info-by-name` - информация о модели по имени файла
...
- **Мониторинг**: постоянное отслеживание входной директории, автоматическая классификация новых документов, перемещение в папку класса или на ручную проверку при низкой уверенности.
...
**Производительность:** обработка файлов выполняется параллельно (многопоточность, до 4 нитей одновременно) для ускорения классификации больших объёмов данных.
